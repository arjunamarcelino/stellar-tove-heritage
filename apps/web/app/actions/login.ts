...
// This action is preserved (commented out) so the password flow can be restored alongside
// components/auth/LoginForm.tsx. The underlying loginUser service (lib/services/auth.ts) is left
// intact. To re-enable: uncomment this and wire LoginForm back onto the /login page.
//
// 'use server';
//
