...
// TEMPORARY: the email/password signup flow has no FE entry point for now, so
// /register redirects to the passkey signup at /signup. The original page is
// preserved (commented out below) so the flow can be restored later.
export default function RegisterPage() {
  redirect('/signup');
}

// --- Original email/password signup page (restore to re-enable the flow) ---
